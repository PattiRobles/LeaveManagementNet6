...
namespace LeaveManagementWeb.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public LeaveTypesController(ILeaveTypeRepository leaveTypeRepository, IMapper mapper)
            //remove "ApplicationDbContext context" from the parameters as we inject it via ILeaveTypeRepository
        {
        ...
        public async Task<IActionResult> Create(LeaveTypeVM leaveTypeVM)
        {
            if (ModelState.IsValid)
            {
                ...
                //above line converts leaveVM to the data type one, so can be added to the _context (i.e.database)
